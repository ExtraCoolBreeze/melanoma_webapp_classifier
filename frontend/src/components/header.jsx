    ...
    <header className="bg-[#EDEEEE] text-[#005EB8] py-4 shadow-md" id="top">
      <div className="max-w-full mx-auto px-4 flex items-center justify-between gap-10">
        <div className="flex items-center gap-4">
          ...
          <div className="text-3xl font-semibold whitespace-nowrap">Spot Check Medical</div>
        </div>

        <Link to="/" className="text-black hover:text-[#005EB8] font-medium transition-colors underline">
          Home
        </Link>
      </div>
    </header>
